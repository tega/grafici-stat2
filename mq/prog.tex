...
\usepackage{babel}
\begin{document}
\textsc{\small{}università della svizzera italiana}\hfill{}\textsc{\small{}facoltà
...
\textbf{\large{(al di là della regressione classica)}} 
\par\end{center}
...
\item [2.3] Quando la matrice delle varianze-covarianze è conosciuta:
i minimi quadrati generalizzati
\begin{itemize}
\item Gli stimatori e le loro proprietà
...
\begin{enumerate}
\item [4.1] Convergenza in probabilità
\begin{itemize}
\item Definizione e proprietà
...
\begin{enumerate}
\item [7.1] Specificazione e proprietà. Moltiplicatori d'impatto, moltiplicatori
...
\begin{enumerate}
\item [8.1] Stazionarietà e non stazionarietà
\begin{enumerate}
\item [8.1.1] Stazionarietà
\item [8.1.2] Non stazionarietà
