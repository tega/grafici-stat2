...
pdf(file="grafici/k005TestUnilateraleDestro.pdf")
...
mtext(expression(k[paste(5,symbol("%"))] == -0.539),side=1,at=c(q95,-1),adj=0)
text(-0.5375,5,expression(paste(alpha == 5, symbol("%"))),cex=1)
