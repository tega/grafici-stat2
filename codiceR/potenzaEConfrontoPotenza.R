...
plot(x,y,xlab=expression(H[A]:~mu),type="l",ylab=expression(beta),
		xlim=c(-0.545,-0.525),ylim=c(0,1))


points(x=-0.545, y=0.05,pch=19)
text(-0.546,0.02,expression(H[0]),pos=4,cex = 0.8)
...
text(-0.535,0.6,expression(Potenza~di~S==min(paste("(",X[1],ldots,X[5],")"))),pos=4,cex=0.8)
