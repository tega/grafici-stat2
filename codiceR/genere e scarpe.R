...
dati <- read.csv(file="dati/dati genere e numero scarpa 2009.csv",
		header=TRUE)
...
xExt <- c(-0.5,x,1.5)
yExt <- c(0,y,0)
pdf(file="grafici/numeroScarpeUomoDonnaFreqRelative.pdf")
...
y <- as.numeric(y)
pdf(file="grafici/numeroScarpeFreqRelative.pdf")
...
pdf(file="grafici/numeroScarpeFunzioneRipartizione.pdf")
xlim=c(34,48)
